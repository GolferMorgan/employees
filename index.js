...
function init() {
  const logoText = logo({ name: "Employee Manager Database" }).render();
      ...
      prompt([
        {
          type: "list",
          name: "departmentId",
          message: "Which department would you like to see all employees?",
      ...
      prompt([
        {
          type: "list",
          name: "managerId",
          message: "Which employee do you want to see information for?",
        ...
        .then(([rows]) => {
          ...
          if (employees.length === 0) {
            console.log("The employee has no information");
          } else {
            console.table(employees);
          }
        })
              ...
              prompt([
                {
                  ...
                  name: "managerId",
                  message:
                    "Which employee is going to be the manager?",
                  choices: managerChoices
                }
              ])
